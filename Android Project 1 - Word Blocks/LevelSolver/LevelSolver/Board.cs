...
namespace LevelSolver
{
    ...
    public class Board
    {
        ...
        public void print(int iter)
        {
            ...
            printBoard();
            if (curCell != null)
                Console.WriteLine("CurCell: " + curCell.Row + ", " + curCell.Col);
            Console.WriteLine("CurLetterIndex: " + curLetterIndex);
            Console.WriteLine("CurWord: " + curWord);
            //Console.WriteLine("CurLetter: " + words[0].Substring(0, 1));
            Console.WriteLine();
        }
    }
}
