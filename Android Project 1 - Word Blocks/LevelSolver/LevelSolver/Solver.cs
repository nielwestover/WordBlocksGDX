...
namespace LevelSolver
{
    ...
    public class Solver
    {
        public virtual List<int> solveBoard(Board b)
        {
            return null;
        }
    }
    internal class SolverPerm : Solver
    {
        public SolverPerm()
        {
        ...
        override public List<int> solveBoard(Board b)
        {
            permutations = Utils.GetStringPermutations(b.words.Reverse<string>().ToList(), b.words.Count);
